document.addEventListener("DOMContentLoaded", function () {
    ...
    window.buildInvitationRow = function (data) {
        ...
        tr.innerHTML =
            ...
            '<td class="col-expand-mobile"><input type="text" class="inv-notes-input" data-inv-id="' + data.invitation_id + '" value="' + window.escapeHtml(data.notes || "") + '" placeholder="Invite note..." autocomplete="nope"></td>' +
